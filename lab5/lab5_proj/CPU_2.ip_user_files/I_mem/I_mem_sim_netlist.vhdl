...
-- Date        : Thu May 19 23:09:53 2022
-- Host        : LAPTOP-47V1HNQK running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim D:/Courses/COD/CPU_2/CPU_2.ip_user_files/I_mem/I_mem_sim_netlist.vhdl
-- Design      : I_mem
...
entity I_mem_spram is
  ...
  attribute ORIG_REF_NAME of I_mem_spram : entity is "spram";
end I_mem_spram;

architecture STRUCTURE of I_mem_spram is
...
ram_reg_0_255_0_0: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000007FFFFFFFF"
    )
        port map (
...
ram_reg_0_255_10_10: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000000000000000000000000000000000000000000000024CA1C870"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(10),
...
ram_reg_0_255_11_11: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000240204810"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(11),
...
ram_reg_0_255_12_12: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000400000000"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(12),
...
ram_reg_0_255_13_13: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000005B19BB6EC"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(13),
...
ram_reg_0_255_15_15: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000640204810"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(15),
...
ram_reg_0_255_16_16: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000403060180"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(16),
...
ram_reg_0_255_17_17: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000643264990"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(17),
...
ram_reg_0_255_18_18: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000400400000"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(18),
...
ram_reg_0_255_20_20: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000000000000000000000000000000000000000000000061DE31805"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(20),
...
ram_reg_0_255_22_22: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000000000000000000000000000000000000000000000000B848120"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(22),
...
ram_reg_0_255_23_23: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000000044380E0"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(23),
...
ram_reg_0_255_24_24: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000520102408"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(24),
...
ram_reg_0_255_30_30: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000007F0B9FE7C"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(30),
...
ram_reg_0_255_4_4: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000000000000000000000000000000000000000000000000E440103"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(4),
...
ram_reg_0_255_5_5: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000006DDEB5AD6"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(5),
...
ram_reg_0_255_7_7: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"000000000000000000000000000000000000000000000000000000036870EC19"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(7),
...
ram_reg_0_255_8_8: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"0000000000000000000000000000000000000000000000000000000002040102"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(8),
...
ram_reg_0_255_9_9: unisim.vcomponents.RAM256X1S
    generic map(
      INIT => X"00000000000000000000000000000000000000000000000000000003F27C7F1E"
    )
        port map (
      A(7 downto 0) => a(7 downto 0),
      D => d(9),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I_mem_dist_mem_gen_v8_0_13_synth is
  port (
    spo : out STD_LOGIC_VECTOR ( 31 downto 0 );
    clk : in STD_LOGIC;
    d : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of I_mem_dist_mem_gen_v8_0_13_synth : entity is "dist_mem_gen_v8_0_13_synth";
end I_mem_dist_mem_gen_v8_0_13_synth;

architecture STRUCTURE of I_mem_dist_mem_gen_v8_0_13_synth is
begin
\gen_sp_ram.spram_inst\: entity work.I_mem_spram
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity I_mem_dist_mem_gen_v8_0_13 is
  port (
    a : in STD_LOGIC_VECTOR ( 7 downto 0 );
    d : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute C_ADDR_WIDTH of I_mem_dist_mem_gen_v8_0_13 : entity is 8;
  attribute C_DEFAULT_DATA : string;
  attribute C_DEFAULT_DATA of I_mem_dist_mem_gen_v8_0_13 : entity is "0";
  attribute C_DEPTH : integer;
  attribute C_DEPTH of I_mem_dist_mem_gen_v8_0_13 : entity is 256;
  attribute C_ELABORATION_DIR : string;
  attribute C_ELABORATION_DIR of I_mem_dist_mem_gen_v8_0_13 : entity is "./";
  attribute C_FAMILY : string;
  attribute C_FAMILY of I_mem_dist_mem_gen_v8_0_13 : entity is "artix7";
  attribute C_HAS_CLK : integer;
  attribute C_HAS_CLK of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_HAS_D : integer;
  attribute C_HAS_D of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_HAS_DPO : integer;
  attribute C_HAS_DPO of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_DPRA : integer;
  attribute C_HAS_DPRA of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_I_CE : integer;
  attribute C_HAS_I_CE of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QDPO : integer;
  attribute C_HAS_QDPO of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QDPO_CE : integer;
  attribute C_HAS_QDPO_CE of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QDPO_CLK : integer;
  attribute C_HAS_QDPO_CLK of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QDPO_RST : integer;
  attribute C_HAS_QDPO_RST of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QDPO_SRST : integer;
  attribute C_HAS_QDPO_SRST of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QSPO : integer;
  attribute C_HAS_QSPO of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QSPO_CE : integer;
  attribute C_HAS_QSPO_CE of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QSPO_RST : integer;
  attribute C_HAS_QSPO_RST of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_QSPO_SRST : integer;
  attribute C_HAS_QSPO_SRST of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_HAS_SPO : integer;
  attribute C_HAS_SPO of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_HAS_WE : integer;
  attribute C_HAS_WE of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_MEM_INIT_FILE : string;
  attribute C_MEM_INIT_FILE of I_mem_dist_mem_gen_v8_0_13 : entity is "I_mem.mif";
  attribute C_MEM_TYPE : integer;
  attribute C_MEM_TYPE of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_PARSER_TYPE : integer;
  attribute C_PARSER_TYPE of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_PIPELINE_STAGES : integer;
  attribute C_PIPELINE_STAGES of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_QCE_JOINED : integer;
  attribute C_QCE_JOINED of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_QUALIFY_WE : integer;
  attribute C_QUALIFY_WE of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_READ_MIF : integer;
  attribute C_READ_MIF of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_REG_A_D_INPUTS : integer;
  attribute C_REG_A_D_INPUTS of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_REG_DPRA_INPUT : integer;
  attribute C_REG_DPRA_INPUT of I_mem_dist_mem_gen_v8_0_13 : entity is 0;
  attribute C_SYNC_ENABLE : integer;
  attribute C_SYNC_ENABLE of I_mem_dist_mem_gen_v8_0_13 : entity is 1;
  attribute C_WIDTH : integer;
  attribute C_WIDTH of I_mem_dist_mem_gen_v8_0_13 : entity is 32;
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of I_mem_dist_mem_gen_v8_0_13 : entity is "dist_mem_gen_v8_0_13";
end I_mem_dist_mem_gen_v8_0_13;

architecture STRUCTURE of I_mem_dist_mem_gen_v8_0_13 is
...
\synth_options.dist_mem_inst\: entity work.I_mem_dist_mem_gen_v8_0_13_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
      d(31 downto 0) => d(31 downto 0),
...
entity I_mem is
  ...
  attribute CHECK_LICENSE_TYPE of I_mem : entity is "I_mem,dist_mem_gen_v8_0_13,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of I_mem : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of I_mem : entity is "dist_mem_gen_v8_0_13,Vivado 2019.2";
end I_mem;
...
architecture STRUCTURE of I_mem is
  ...
  attribute c_mem_init_file : string;
  attribute c_mem_init_file of U0 : label is "I_mem.mif";
  attribute c_parser_type : integer;
...
begin
U0: entity work.I_mem_dist_mem_gen_v8_0_13
     port map (
      a(7 downto 0) => a(7 downto 0),
      clk => clk,
      d(31 downto 0) => d(31 downto 0),
