...
begin
  ...
  spo(20) <= \^spo\(2);
  spo(19) <= \^spo\(2);
  spo(18 downto 17) <= \^spo\(16 downto 15);
  spo(16 downto 15) <= \^spo\(16 downto 15);
  spo(14) <= \^spo\(2);
  spo(13) <= \^spo\(13);
  spo(12) <= \^spo\(2);
  spo(11) <= \<const0>\;
  spo(10 downto 9) <= \^spo\(8 downto 7);
...
\synth_options.dist_mem_inst\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_dist_mem_gen_v8_0_13_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      spo(9) => \^spo\(2),
      spo(8 downto 7) => \^spo\(23 downto 22),
      spo(6 downto 5) => \^spo\(16 downto 15),
      spo(4) => \^spo\(13),
      spo(3 downto 2) => \^spo\(8 downto 7),
      spo(1) => \^spo\(4),
      spo(0) => \^spo\(0)
    );
end STRUCTURE;
